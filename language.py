...
language = {
    'RU':{
        ...
        "Set departure location": "Укажите координаты <b>отправления</b>. Воспользуйтесь ОДНИМ из 3-х способов:\n\n1️⃣ способ - напишите название и отправьте \n2️⃣ способ - выберите название в КАТАЛОГЕ МЕСТ \n3️⃣ способ - укажите координаты на карте через СКРЕПКУ+ЛОКАЦИЯ",
        "Set destination location": "Укажите координаты <b>назначения</b>. Воспользуйтесь ОДНИМ из 3-х способов:\n\n1️⃣ способ - напишите название и отправьте \n2️⃣ способ - выберите название в КАТАЛОГЕ МЕСТ \n3️⃣ способ - укажите координаты на карте через СКРЕПКУ+ЛОКАЦИЯ",
