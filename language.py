...
language = {
    'RU':{
        ...
        "To pay for a subscription you need to transfer the currency to the specified crypto wallet. After the payment has been made Confirm the transfer with the button": "Для оплаты подписки вам необходимо: \n1. <b>Перевести валюту</b> на указанный криптокошелёк. \n2. После произведённой оплаты <b>подтвердить перевод</b> кнопкой",
        ...
        "You need to pay for a subscription": "Вам необходимо оплатить подписку",
