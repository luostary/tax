...
language = {
    'RU':{
        ...
        "To work in the system, you must have at least {minAmount:d} usdt on your account. To replenish the account, you need to transfer the currency to the specified crypto wallet: {wallet:s}": "Для работы в системе необходимо иметь на счету не меньше {minAmount:d} usdt. Чтобы пополнить счёт необходимо перевести валюту на указанный криптокошелёк: {wallet:s}",
