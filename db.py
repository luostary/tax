...
class BotDB:
    ...
    statuses = {
        ...
        # Заказ
        'create': 'Создан 🟡', # Водитель не выбран, система предлагает заказ водителям, клиент ожидает водителя
        'waiting': 'Ожидает машину 🟢', # Водитель выбран, клиент ожидает подачу машины
        'progress': 'В пути 🟠', # Подача машины осуществлена, клиент в пути
        'done': 'Выполнен 🔵', # Клиент доставлен, водитель или клиент нажали кнопку "Заказ выполнен"
        'cancel': 'Отменен ⚫', # Заказ не выполнен, водитель или клиент нажали кнопку "Отменить заказ"
